...
<%
ArrayList<HashMap<String, Object>> list = (ArrayList<HashMap<String, Object>>)session.getAttribute("goodslist");
ArrayList<HashMap<String, Object>> list1 = (ArrayList<HashMap<String, Object>>)session.getAttribute("orderitemlist");
ArrayList<HashMap<String, Object>> list2 = (ArrayList<HashMap<String, Object>>)session.getAttribute("orderid");
%>
        ...
        <div class="content1-2">
            ...
            <div class="content1-4">
                ...
                <div class="content1-12">
                    <div class="content1-13">&nbsp;&nbsp;&nbsp;<font color="#666666"><b>订单号：</b> <%=list2.get(0).get("oid") %></font> &nbsp;&nbsp;&nbsp;&nbsp;<font color="#666666">
                    <b>状态：
                    	<%if(list2.get(0).get("state").toString().equals("0")){ %>
                      		未付款
                      <%} %>
                       <%if(list2.get(0).get("state").toString().equals("1")){ %>
                      		未发货
                      <%} %>
                       <%if(list2.get(0).get("state").toString().equals("2")){ %>
                      		未签收
                      <%} %>
                       <%if(list2.get(0).get("state").toString().equals("3")){ %>
                      		已签收
                      <%} %>
                    </b>
                    </font></div>
                    <div class="content1-14"><font color="#666666">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;创建订单&nbsp;&nbsp;>&nbsp;&nbsp; 取消订单</font></div>
                    <div class="content1-15">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/100.png" /></div>
                    <div class="content1-16"><font size="-1" color="#666666">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=list2.get(0).get("ordertime") %> &nbsp;&nbsp;&nbsp;&nbsp;2016-09-06</font></div>
                    <div class="content1-17"><font size="-1" color="#666666">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12:34:19 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12:35:33</font></div> 
                </div>
                
                <div class="content1-18">
                
                <div class="content1-19"><font color="#666666"><b>收货信息</b></font></div>
                <div class="content1-20">${user.name} - ${user.mobile_number} - ${user.address} - 邮编:414000 - 工作日送货</div>  
                ...
                <div class="content1-22"><font color="#666666"><b>支付方式</b></font></div>
                <div class="content1-23">支付宝</div>  
                
                </div>
                
                 <div class="content1-24">
                
                <div class="content1-25"><font color="#666666"><b>会员独享服务</b></font></div>
                <div class="content1-26">发货单显示金额</div>  
                
                </div>
              	
                <%for(int i=0;i<list.size();i++){ %>
                <div class="content2-4">
                      <div class="content2-4-1">21-013-461<%=list1.get(i).get("iid")%></div>
                      <div class="content2-4-2"><img width="99.7%" height="60" src="image/<%=list.get(i).get("image")%>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*<%=list1.get(i).get("COUNT")%></div>
                      <div class="content2-4-3"><%=list.get(i).get("gintrodue")%>(G20峰会，9月7号前江浙地区的停止收发货，其他地区正常发货，7号江浙地区恢复正常，敬请谅解)
<br>颜色：蓝色 尺码：M </div>
                      <div class="content2-4-4"><b>￥<%=list.get(i).get("price")%></b></div>
                     
                      <div class="content2-4-6"><%=list1.get(i).get("subtotal")%></div>
                </div>
                 <%} %>
                ...
                <div class="content2-6">
                
                    <div class="content2-6-1">您在本次交易中使用了</div>
                    
                    <div class="content2-6-2">
                    
                    <div class="content2-6-2-1"><b>银元</b></div>
                    <div class="content2-6-2-2">￥0</div>
                    
                    <div class="content2-6-2-3"><b>余额</b></div>
                    <div class="content2-6-2-4">￥0</div>
                    
                    <div class="content2-6-2-5"><b>银泰卡</b></div>
                    <div class="content2-6-2-6">￥0</div>
                    </div>
                ...
                <div class="content2-7">
                
                    <div class="content2-7-1">
                         <div class="content2-7-1-1"><a href="">查看此单优惠信息</a></div>
                         <div class="content2-7-1-2">商品总价：￥<%=list2.get(0).get("total") %><br /><br />节省金额：￥0.00<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;运费：￥0</div>
                    </div>
                    <div class="content2-7-2"><b>已支付金额：<font color="#FF0000">￥0</font></b></div>
                
                </div>
                
                <div class="content2-8">
                <input type="button" value="返回订单中心"/>
                </div>
...
<script>
	function img1(){
		var a = document.getElementById("img1");
			...
			if(a.src=="http://localhost:8080/xiangmu/image/2.png"){
					a.src="image/22.png"
				}else{
						a.src="image/2.png"
					}
