...
HashMap<String, Object> list1 = (HashMap<String, Object>)session.getAttribute("user");
ArrayList<HashMap<String, Object>> goodslist1 = (ArrayList<HashMap<String, Object>>)session.getAttribute("goodlist1");
              ...
              <form action="" method="post">
               <div class="content1-14">
                    ...
                    <div class="content1-26">
                        ...
                        <div class="content1-18"><img src="image/<%=goodslist1.get(i).get("image") %>" width="47" height="63" /></div>
                        <div class="content1-19"><%=list1.get("name") %></div>
                      ...
                      <%} %>
                        ...
                        <a href="OrderServlet1?oid=<%=list.get(i).get("oid")%>&state=<%=list.get(i).get("state")%>">
                      ...
                      <%} %>
                        ...
                        <a href="OrderServlet9?oid=<%=list.get(i).get("oid")%>&state=<%=list.get(i).get("state")%>"">订单详情</a>
                        <a href="OrderServlet3?oid=<%=list.get(i).get("oid")%>&state=<%=list.get(i).get("state")%>">取消订单</a>
                        </div>
                    </div>
                    <%} %>
               </div>
