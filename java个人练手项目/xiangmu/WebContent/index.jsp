...
<body>
	...
	<div class="top">
           ...
           <div class="login1">您还未登录,<a href="denglu.html">请登录</a><a href="zhuce.html">注册</a></div>
            ...
            <div class="ulright">
            	<ul>
                    ...
                    <li><a href="message.jsp">我的银泰</a></li>
                    <li><a href="#">银泰卡</a></li>
                    <li><a href="#">帮助中心	</a></li>
        ...
        <div class="top2">
            ...
            <div class="top2-3"><input /><div class="top2-4"><a href="gouwuche1.html">购物车0件</a></div><button>搜索</button></div><!-- 右边边-->
    ...
    <div class="content">
        ...
        <div class="content2">
            ...
            <div class="content2-2">
            	<div class="content2-3">
                	<img src="image/yintai_09e627e4-5693-43ca-bdd3-ec7c53130a4d.jpg"/>
                    <div class="content2-4">
                    	<a href="#">银泰百货武林总店 BC馆泰兰尼斯男</a>
                        <strong>银泰价：￥279</strong>
                        <span>参考价：￥438</span>
                    </div>
                </div>
                <div class="content2-3">
                <img src="image/41600.jpg"/>
                	<div class="content2-4">
                    	<a href="#">IPSA茵扶莎纯美无暇修饰遮瑕膏<br /></a>
                        <strong>银泰价：￥290</strong>
                        <span>参考价：￥290</span>
                    </div>
                </div>
                <div class="content2-3">
                	<img src="image/yintai_c90ee978-4205-434c-b50d-ce57bcd39cfe.jpg"/>
                    <div class="content2-4">
                    	<a href="#">初语2016夏装新款纯棉短袖T恤小...</a>
                        <strong>银泰价：￥79</strong>
                        <span>参考价：￥259</span>
                    </div>
                </div>
                <div class="content2-3">
                	<img src="image/31708.jpg"/>
                    <div class="content2-4">
                    	<a href="#">adidas阿迪达斯男子常新系列阿迪...</a>
                        <strong>银泰价：￥59</strong>
                        <span>参考价：￥99</span>
                    </div>
                </div>
            </div>
            <div class="content2-5"><img src="image/907afae4-74df-4d3f-bfa0-ff2b963f4201.jpg" /></div>
        ...
        <div class="content3">
        	<div class="content3-1">
            	<img src="image/81be48c4-2457-44e1-92e2-24bd30dc99ec.jpg" />
            </div>
            <div class="content3-2">
                ...
                <div class="content3-4">    
                	<div class="content3-5">
                   		<img src="image/yintai_c58899ea-67b4-472f-8392-28853389cf65.jpg" />
                        <div class="content2-4">
                    	<a href="#">银泰百货武林店ifbyeva印花无袖</a><br />
                       <h6>￥59--参考价：￥99</h6>
                    </div>
                   </div>
                   <div class="content3-5">
                   		<img src="image/10037595545_1.jpg"/>
                        <div class="content2-4">
                    	<a href="#">银泰百货杭州下沙工厂店</a><br />
                       <h6>￥179--参考价：￥689</h6>
                    </div>
                   </div>
                   <div class="content3-5">
                   		<img src="image/10041056215_1.jpg"/>
                        <div class="content2-4">
                    	<a href="#">银泰百货武林总店A馆Happy</a><br />
                       <h6>￥129--参考价：￥129</h6>
                    </div>
                   </div>
                   <div class="content3-5">
                   		<img src="image/10031149376_1.jpg"/>
                        <div class="content2-4">
                    	<a href="#">银泰百货武林levis印花无袖</a><br />
                       <h6>￥199--参考价：￥199</h6>
                    </div>
                   </div>
                   <div class="content3-5">
                   		<img src="image/10021356961_1.jpg"/>
                        <div class="content2-4">
                    	<a href="#">银泰百货文化广场Millies妙丽</a><br />
                       <h6>￥499--参考价：￥1299</h6>
                    </div>
                   </div>
                   <div class="content3-5">
                   		<img src="image/10021054535_1.JPG"/>
                        <div class="content2-4">
                    	<a href="#">银泰百货武林广场店BELLE百丽</a><br />
                       <h6>￥229--参考价：￥859</h6>
                    </div>
                   </div>
                   <div class="content3-5">
                   		<img src="image/yintai_d8ed2a01-9553-4d0c-9159-9248e60ca491.jpg"/>
                        <div class="content2-4">
                    	<a href="#">银泰百货武林广场店BC馆泰兰尼斯</a><br />
                       <h6>￥99--参考价：￥228</h6>
                    </div>
                   </div>
                   <div class="content3-5">
                   		<img src="image/yintai_3ef93972-585c-41a2-ad14-0b67b9f0a404.jpg" />
                        <div class="content2-4">
                    	<a href="#">银泰百货武林TARANIS</a><br />
                       <h6>￥139--参考价：￥368</h6>
                    </div>
                   </div>
        ...
        <div class="content4">
            ...
            <div class="content4-5"><img src="image/41fc51c1-8eee-4ec8-9506-57e5773fc802.jpg" height="390px" width="390px" /></div>
             <div class="content4-6">
             	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/60fa93af-862d-4050-a21a-a44d91ca3cf5.jpg" />
                </div>
                </a>
               	<a href="#"> <div class="content4-7" id="content4-7">
                	<img src="image/7df45fc2-2f4b-4d79-8b60-6b4fe7e93fec.jpg"/>
                </div>
                 </a>
                	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/fb9b9c8a-9682-4e0a-873f-681b2aae0f54.jpg"/>
                </div>
                 </a>
               	<a href="#"> <div class="content4-7" id="content4-7">
                	<img src="image/379a5408-0648-49d0-b393-c1bfd697fa22.jpg"/>
                </div>
                 </a>
             </div>
        </div>
        ...
        <div class="content4">
            ...
            <div class="content4-5"><img src="image/ff7dc82a-c94a-43ea-bb7f-752e8a8bc8a3.jpg" height="390px" width="390px" /></div>
             <div class="content4-6">
             	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/25a7b76d-33d1-4938-9c95-e91e86bdc389.jpg" />
                </div></a>
               	<a href="#"> <div class="content4-7" id="content4-7">
                	<img src="image/00794654-e6b5-44c3-8cc1-b5570e496a65.jpg"/>
                </div></a>
                	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/3b49ce8c-94b5-4eb4-b40b-69090a0d953c.jpg"/>
                </div></a>
               	<a href="#"> <div class="content4-7" id="content4-7">
                	<img src="image/221ae20d-c8e5-4db4-ac14-7bd0327760a4.jpg"/>
                </div></a>
             </div>
        </div>
        ...
        <div class="content4">
            ...
            <div class="content4-5"><img src="image/985b3c0e-2929-46c1-937d-51469bbb3cac.jpg" height="390px" width="390px" /></div>
             <div class="content4-6">
             	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/3897b204-8cc0-4f76-9887-3559d29309a3.jpg" />
                </div></a>
                	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/63a705b8-44bc-4615-a61e-d138abd698c5.jpg" />
                </div></a>
                	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/d8d86de6-4673-453e-934e-91e868cfcdfc.jpg"/>
                </div></a>
                	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/2fe93873-45d9-43f9-89f2-42cea2d6d900.jpg"/>
                </div></a>
             </div>
        </div>
        ...
        <div class="content4">
            ...
            <div class="content4-5"><img src="image/32a65b34-bcff-4849-a35d-14eb1891b5fd.jpg" height="390px" width="390px" /></div>
             <div class="content4-6">
             	<a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/14be5aa8-ecad-4f1e-9d4b-756c92eec7ec.jpg" />
                </div></a>
               <a href="#"> <div class="content4-7" id="content4-7">
                	<img src="image/1c499160-d7f2-4ad3-b12c-972736fb2f28.jpg"/>
                </div></a>
               <a href="#"> <div class="content4-7" id="content4-7">
                	<img src="image/5bea761e-940b-4654-ba57-a67db113b25e.jpg"/>
                </div></a>
                <a href="#"><div class="content4-7" id="content4-7">
                	<img src="image/d1efc12b-e04e-4193-bf71-09f3ca38b923.jpg"/>
                </div></a>
             </div>
        </div>
        <div class="content6">
    ...
    <div class="guding">
    	<ul>
            ...
            <li><a href="#2F">爆款特卖</a></li>
            <li><a href="#3F">潮流女装</a></li>
            <li><a href="#4F">精品男装</a></li>
            <li><a href="#5F">时尚鞋靴</a></li>
            <li><a href="#6F">潮流箱包</a></li>
            <li><a href="#7F">运动户外</a></li>
        </ul>
    </div>
</body>
</html>
<script> 
	...
	function li(){
			...
			var a = ['image/858c5d75-0fc2-402f-9956-726522b52a05.jpg','image/23.jpg','image/24.jpg'];
