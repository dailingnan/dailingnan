    ...
    <div class="content">
        ...
        <div class="content1-2">
            ...
            <form action="regist" method="post">
                ...
                <input type="text" id="text2" /><span class="content1-9"></span>
                <div class="content1-9" id="t2" name="password">请输入登录密码</div>
                <input type="text"  id="text3"/><span class="content1-9"></span>
                <div class="content1-9" id="t3" name="password">确认密码</div>
               <div class="content1-11"><input type="text" /></div><div class="content1-12"><img src="image/QQ截图20160811150737.png" /></div>
