    ...
    <div class="content">
        ...
        <div class="content1-2">
            ...
            <form>
               ...
               <div class="content1-11"><input type="text" id="text3" /></div><div class="content1-12"><img   id="img" src="/dbdemo1/Verify"/></div>
               <div style="clear:left;"></div>
                <div class="content1-9" id="t3">请输入右侧图中的验证码</div>
               <div class="content1-14"> <button type="button" id="btn1">登录-SING IN</button></div>
              </form>
	...
	function img1(){
		...
		function change(text1){
			...
			img.onclick = function(){
				img.src="/dbdemo1/Verify?a="+new Date().getTime();
			}
