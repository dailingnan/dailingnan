...
<div class="top">
    ...
    <div class="content">
        ...
        <span style="margin-left: -600px; color: red">${msg}</span>
            ...
            <form action="Login1" method="post" onsubmit="return check()">
            	<input type="text" id="text1" name="username" />
                <div class="content1-9" id="t1">请输入E-mail或手机号码</div>
                <input type="password" id="text2" name="password" /><span class="content1-9">&nbsp;忘记密码？</span>
                <div class="content1-9" id="t2" >请输入登录密码</div>
               <div class="content1-11">
               <input type="text" id="text3" name="vc" /></div><div class="content1-12"><img   id="img" src="/xiangmu/Verify"/></div>
