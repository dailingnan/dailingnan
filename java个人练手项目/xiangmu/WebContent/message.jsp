        ...
        <div class="content1-2">
            ...
            <div class="content1-4">
                ...
                <div style="width:100%; border:#666666 solid 1px; height:100%;">
                	<div class="yb1">用户帐号：${user.username} </div>
                	<div class="yb1">&nbsp;用户名：<input type="text" name="username1" value="${user.name}" /> </div>
                    <div class="yb1">手机号码：<input type="text"  name="phone" value="${user.mobile_number}"/> </div>
                    <div class="yb1">收货地址：<input type="text" name="address" value="${user.address}" /> </div>
