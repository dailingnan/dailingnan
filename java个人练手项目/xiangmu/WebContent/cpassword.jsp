...
<div class="top">
    ...
    <div class="content">
    	<div class="content1">
        	<div class="content1-1"><span class="span1">修改密码</span> <span class="span2">NEW USER LOGIN</span></div>
        ...
        <span style="margin-left: -600px; color: red">${msg}</span>
        	<div class="content1-4">
                ...
                <div class="content1-6"><span>旧登录密码</span></div>
                 <div class="content1-6"><span>新登录密码</span></div>
                <div class="content1-7"><span>再次确认密码</span></div>
            ...
            <form method="post" action="ChangePassword" onsubmit="return check()">
                ...
                <input type="password" id="text2" name="fpassword"/><span class="content1-9"></span>
                <div class="content1-9" id="t2">请输入6-18位之间的字符</div>
                <input type="password"  id="text3" name="npassword"/><span class="content1-9"></span>
                  <div class="content1-9" id="t3">请输入6-18位之间的字符</div>
                <input type="password"  id="text4"/><span class="content1-9"></span>
                <div class="content1-9" id="t4" name="npassword">请输入6-18位之间的字符</div>
