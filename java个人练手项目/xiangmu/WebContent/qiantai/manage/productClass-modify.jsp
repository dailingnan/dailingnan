	...
	<div class="main">
		...
		<div class="manage">
			<form action="" method="post">
				<fieldset>
				<legend style="color: orange;">一级分类修改</legend>
				<table class="form">
						<tr>
							<td class="field">一级分类名称：</td>
							<td>
								<input type="text" class="text" name="className" value="" />
								<span class="calssName" style="color:red"></span>
							</td>
						</tr>
						<tr>
							<td></td>
			...
			<form action="" method="post">
				<fieldset>
				<legend style="color: orange;">二级分类修改</legend>
				<table class="form">
							<tr>
							...
							<tr>
								...
								<td><label class="ui-blue"><input type="submit"
										name="submit" value="更新" /> </label>
								</td>
							</tr>
							<tr>
								<td class="field">修改所属分类：</td>
								<td><select>
