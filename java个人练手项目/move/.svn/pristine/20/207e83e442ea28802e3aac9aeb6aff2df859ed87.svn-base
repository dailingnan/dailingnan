		...
		<div class="content">
        	...
        	<div class="content2">
            	<div class="content2_1">
                	<img src="/move/img/${moveBean.image}" />
                ...
                <div class="content2_2">
                	<div class="content2_4">
                    	<div class="content2_6">${moveBean.name}</div>
                        <div class="content2_7">
                        	<div class="content2_8">${moveBean.title}</div>
                            <div class="content2_9"><font color="#999999">上映日期：</font>${moveBean.screentime}  [上映中]</div>
                            <div class="content2_10"><font color="#999999">片长/语言：</font>${moveBean.time}分钟/国语</div>
                            <div class="content2_9"><font color="#999999">导演/演员：</font>${moveBean.director}/${moveBean.actor}</div>
                            <div class="content2_10"><font color="#999999">类型</font>${moveBean.classes}</div>
            ...
            <div class="content3">
            	...
            	<div class="content3_1">
                    ...
                    <div class="content5_6">
                    	<div class="content5_7">${moveBean.name}  剧情简介 </div>
                        <div class="content5_8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${moveBean.introduce}</div>
                    </div>
                    <div class="content8">
                    ...
                    <!------------------------------------------------------------------>
                   	<c:forEach items="${discussList}" var="dis">
                   		 <div class="content9">
                    ...
                    <div class="content6">
                     ...
                     <form action="/move/insertDiscuss.html" method="post" >
