...
<body>
	...
	<table id="dg" class="easyui-datagrid" title="电影排片查看" style="width:700px;height:250px"
...
<script>
	    ...
	    columns:[[
	        ...
	        {field:'onscreendate',title:'上映时间',width:220,formatter: formatDatebox, editor: 'datebox', sortable: true,}, 
