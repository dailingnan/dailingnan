...
<body>
	<div class="content">
            ...
            <form action="/move/houtai/updateMoveArrange.html" method="post">
            <input type="hidden" value="${moveArrangeBeans.marrangeid}" name="marrangeid"/>
            <input type="hidden" value="${moveArrangeBeans.move.moveid}" name="moveid"/>
            <div class="content2">
                ...
                <div class="content2_2">
                	<div class="content2_4">
                    	<select name="name">
                    	<option selected = "selected">${moveArrangeBeans.move.name}</option>
                    ...
                    <div class="content2_4">
                    	<select name="screenhall">
                    		<option selected = "selected">${moveArrangeBeans.screenhall}</option>
                        	<option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="content2_4">
                    	<select name="edition">
                    		<option selected = "selected">${moveArrangeBeans.edition}</option>
                        	<option>原版</option>
                            <option>首映</option>
                        </select>
                    </div>
                    <div class="content2_4">
						...
						<input class="easyui-datetimebox" value="${moveArrangeBeans.onscreendate}"
