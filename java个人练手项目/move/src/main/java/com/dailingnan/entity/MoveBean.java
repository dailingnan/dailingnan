...
public class MoveBean {
	...
	public MoveBean( String name, String classes, String director, String actor, int time,
	...
	public MoveBean(Integer moveid, String name, String classes, String director, String actor, int time,
			String language, float price, Date screentime, String introduce, String image, String title,CinemaBean cinema) {
		super();
		this.moveid = moveid;
		this.name = name;
