...
<title>cinema</title>
<link rel="stylesheet" type="text/css" href="/move/css/cinema.css"/>
</head>
...
<!----------------------------------------------------顶部-------------------------------------------------------->
		<div class="content">
        	<div class="content1">电影首页>电影院><font color="#FF0000">${map.cinemaBean.name}</font></div>
        	<div class="content2">
            	<div class="content2_1">
                	<img src="/move/img/${map.cinemaBean.image}" width="220" height="200"></img>
                ...
                <div class="content2_2">
                	<div class="content2_4">
                    	<div class="content2_6">${map.cinemaBean.name}</div>
                        <div class="content2_7">
                        	<div class="content2_8">${map.cinemaBean.introduction}</div>
                            <div class="content2_9"><font color="#999999">影院地址：</font>${map.cinemaBean.address}</div>
                            <div class="content2_10"><font color="#999999">联系电话：</font>${map.cinemaBean.telephoto}</div>
            ...
            <div class="content3">
            	...
            	<div class="content3_1">
                	<div class="content3_3">
                    	<ul>
                        	<li><a href="#">排片购票</a></li>
                            <li><a href="/move/findCinemaDiscuss.html?cinemaid=${map.cinemaBean.cinemaid}">剧情影评</a></li>
                            <li><a href="#">剧照/预告片</a></li>
                            <li><a href="#">电影资讯</a></li>
                        </ul>
                          <div style="clear:left"></div>
                    </div>
                    <div class="content3_12">
                    	<ul>
                            <c:forEach var="move" items="${map.moveList}" begin="0" end="5">
                             <li><a href="/move/findCinema.html?CineamId=${map.cinemaBean.cinemaid}&moveId=${move.moveid}"><img src="/move/img/${move.image}" height="160px" width="120px" /></a></li>
                            </c:forEach>		
                        </ul>
                        <div style="clear:left"></div>
                    </div>
                    <div class="content3_4">
                    	<div class="content3_5">
                        	<div class="content3_6">今天</div>
                            <div class="content3_7">01月04号</div>
                        </div>
                        <div class="content3_5">
                        	<div class="content3_6">明天</div>
                            <div class="content3_7">01月05号</div>
                        </div>
                        <div class="content3_5">
                        	<div class="content3_6">后天</div>
                            <div class="content3_7">01月06号</div>
                        </div>
                        <div style="clear:left"></div>
                        <div class="content3_8">
                         	<div class="content3_9">影院：</div>
                            <div class="content3_10">
                            	<div class="content3_11">
                                	<ul>
                                	<li><a href="#" class="a3">佛山17.5影城-大沥店</a></li>
                                    <li><a href="#">佛山17.5影城-大沥店</a></li>
                                    <li><a href="#">佛山17.5影城-店</a></li>
                                    <li><a href="#">佛山17.5影城-大沥店</a></li>
                                    <li><a href="#">佛山17.5影城-大沥店</a></li>
                                    <li><a href="#">佛山17.5影城-大沥店</a></li>
                                    <li><a href="#">佛山17.5影城-大沥店</a></li>
                    ...
                    <div class="content4">
                    	<div class="content4_5">
                        	<div class="content4_1"><a href="#">${map.moveBean.name}</a></div>
                            <div class="content4_2">&nbsp;评分：<font color="red" size="4"><b>7.5</b></font></div>
                            <div class="content4_4"><img src="/move/img/26.png" /></div>
                            <div style="clear:left"></div>
                        </div>
                    </div>
                    <div class="content5">
                    	<div class="content5_1">
                        	<div class="content5_2">时间</div>
                            <div class="content5_2">语言/特效</div>
                            <div class="content5_2">放映厅</div>
                            <div class="content5_2">优惠/标识</div>
                            <div class="content5_2">蜘蛛价/影院价</div>
                             <div class="content5_2">选座/预览价</div>
                            <div style="clear:left"></div>
                        </div>
                        <!---------------------循环------------------------------->
                        <c:forEach items="${map.arrangeBeans}" var="arrange" varStatus="varstatus"> 
                        	<div class="content5_3">
	                        	<div class="content5_5">${map.timelist[varstatus.index]}<div class="content5_4">3:50散场</div></div>
	                            <div class="content5_5">${arrange.move.language}<div class="content5_4">2D</div></div>
	                            <div class="content5_2">${arrange.screenhall}号厅</div>
	                            <div class="content5_2">${arrange.move.price}元 (50.00)</div>
	                            <div class="content5_2"><img src="/move/img/27.png" /></div>
	                            <div class="content5_2"><a href="/move/cart.html?marrangeid=${arrange.marrangeid}" class="a4">选座购票</a></div>
	                            <div style="clear:left"></div>
                        	</div>
                        </c:forEach>
                    ...
                    <div class="content5_6">
                    	<div class="content5_7">${map.moveBean.name}剧情简介 </div>
                        <div class="content5_8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${map.moveBean.introduce}</div>
                    </div>
                    <div class="content6">
                    	吐丝
                    </div>
                    <div class="content7">
                    	<textarea class="text1"></textarea><input type="submit" value="发表"  class="btn1"/>
                    </div>
                </div>
                <!---------------------------------content  right------------------------------------------------------->
