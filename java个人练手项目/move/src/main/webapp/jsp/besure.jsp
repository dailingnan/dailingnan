...
<title>index</title>
<link rel="stylesheet" type="text/css" href="/move/css/besure.css"/>
</head>
            ...
            <!-------------------------订单------------------------------------->
            	<div class="content2">
                	<div class="content2_1">
                    	<img src="/move/img/${moveArrangeBean.move.image}"  width="65px" height="82"/>
                    </div>
                    <div class="content2_2">
                    	<div class="content2_6">影片/版本</div>
                        <div class="content2_7">${moveArrangeBean.move.name}</div>
                        <div class="content2_8">${moveArrangeBean.move.language}/2D</div>
                    </div>
                    <div class="content2_3">
                    	<div class="content2_6">影片/场次</div>
                        <div class="content2_7">影院：${moveArrangeBean.cinema.name}</div>
                        <div class="content2_9">场次：${moveArrangeBean.onscreendate} ${moveArrangeBean.screenhall}号厅</div>
                        <div class="content2_8">预计19:35散场</div>
                    </div>
                    <div class="content2_4">
                    	<div class="content2_6">座位</div>
                        <div class="content2_8">
                        <c:forEach items="${orderItems}" var="oit">
		<fmt:formatNumber type="number" value="${(oit.seat-oit.seat%10)/10+1}"/>排${oit.seat%10+1}座 
                       	</c:forEach>
                        </div>
                    </div>
                    <div class="content2_5">
                    	<div class="content2_6">取票手机号码</div>
                        <div class="content2_8">15580106740</div>
                    </div>
                </div>
             <!---------------------------------------------------------------------------->
             <div>
             	<img  src="/move/img/33.png" />
             </div>
             <a href="/move/updateState.html?oid=${orderItems[0].order.orderid}"><div class="content3">确认支付</div></a>
