...
<div class="top">
    ...
    <div class="content">
        ...
        <span style="margin-left: -600px; color: red">${msg}</span>
            ...
            <form action="registAction" method="post" onsubmit="return check()">
            	<input type="text" id="text1" name="user.username"/>
                <div class="content1-9" id="t1">请输入E-mail或手机号码</div>
                <input type="password" id="text2"  name="user.pwd" /><span class="content1-9"></span>
                <div class="content1-9" id="t2" >请输入6-18位之间的字符</div>
                <input type="password"  id="text3" name=""/><span class="content1-9"></span>
                <div class="content1-9" id="t3" >确认密码</div>
               <div class="content1-11"><input type="text" name="vc" /></div><div class="content1-12">
