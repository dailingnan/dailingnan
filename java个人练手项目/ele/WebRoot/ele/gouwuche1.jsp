    ...
    <div class="content">
        ...
        <div class="ordercontent_2">
            ...
            <div class="ordercontent_6">热门问题 随时关注订单状态</div>
             ...
             <s:iterator id="cart" value="carts">
          	   <!--订单项-->
            <div class="ordercontent_12">
                ...
                <div class="ordercontent_16">
                	<div class="ordercontent_27">
                    	    <table id="tab">
                               ...
                               <span class="price">${cart.fd.price}</span>
                                <input class="min" name="" type="button" value="-" onclick="dianji1(${cart.gcid})" />
                                <input class="text_box" name="" type="text" value="${cart.num}" />
                                <input class="add" name="" type="button" value="+" onclick="dianji(${cart.gcid})" />
              ...
              <div class="ordercontent_31">
              		<div class="ordercontent_34"><input type="submit"  value="购物结算"/></div>
               		<div class="ordercontent_33"><label id="total"></label></div>
...
function dianji(gcid){
	...
	function abcd(gcid){
				...
				rqu.open("get", "ele/updateaddAction?gcid="+gcid,false);
				rqu.send(null);
	...
	function abcd1(gcid){
				...
				var rqu = new XMLHttpRequest();
				rqu.onreadystatechange = null;
				rqu.open("get", "ele/updatedecAction?gcid="+gcid,false);
				rqu.send(null);
...
<!--<script>setTimeout("location =location; ",5000); </script> 每隔5秒钟刷新一次页面-->
</html>
