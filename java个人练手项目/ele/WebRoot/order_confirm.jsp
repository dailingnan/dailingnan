...
<link  rel="stylesheet" style="text/css" href="css/order_confirm.css"/>
</head>

<body>
       <div class="top"> <img src="img/17.PNG"/></div>
       ...
       <div class="content">
               <div class="left">
                      ...
                      <font color="#999999"><b> 商品</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#999999"><b>份数</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#999999"><b>小计（元）</b></font>
                       ...
                       <div class="left_3">
                       笑脸薯饼-番茄酱&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="-" class="min" /><input type="text" value="1" class="text1" /><input type="button" value="+" class="max" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥20.00
                       </div>
                       <div class="left_4">
                       餐盒费&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥1.00
                       </div>
                       ...
                       <div class="left_6">
                       合计：<font size="+2" color="#FF0000"><b>¥22.00</b></font>
                       </div>
               </div> 
               
               
               <form action="order_confirmAction" method="get">
               <div class="right">
                        <div class="right_1">
                        ...
                        <div class="right_2">
                               ...
                               <div class="right_2_2">
                               蟹粉豆腐 先生 13533627743<br />中南大学(南校区)受到收到
                               </div>
                               <div class="right_2_3">
                               <img  src="img/19.PNG"/>
                               </div>
                        ...
                        <div class="right_6">
                             ...
                             <br /><br /><input type="submit" class="input_1" value=""/>
                        </div>
               </div>
               </form>
       </div>
